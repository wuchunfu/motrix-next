export default {
  ...
  'db-reset': 'Veritabanını sıfırla',
  'db-reset-confirm': 'Tüm indirme kayıtlarını silmek istediğinizden emin misiniz? Bu işlem geri alınamaz.',
  'db-reset-success': 'Veritabanı başarıyla sıfırlandı',
  ...
  'db-maintenance': 'Veritabanı bakımı',
  'reset': 'Sıfırla',
  'tray': 'Sistem tepsisi',
