export default {
  ...
  'engine-restart-confirm': 'Ορισμένες αλλαγές απαιτούν επανεκκίνηση του μηχανισμού λήψης για να τεθούν σε ισχύ. Οι ενεργές λήψεις θα διακοπούν στιγμιαία αλλά θα συνεχιστούν αυτόματα μετά την επανεκκίνηση.',
