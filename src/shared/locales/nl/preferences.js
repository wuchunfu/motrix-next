export default {
  ...
  'db-reset': 'Database resetten',
  'db-reset-confirm': 'Weet u zeker dat u alle downloadrecords wilt wissen? Deze actie kan niet ongedaan worden gemaakt.',
  'db-reset-success': 'Database succesvol gereset',
  ...
  'db-maintenance': 'Databaseonderhoud',
  'reset': 'Herstellen',
  'tray': 'Systeemvak',
