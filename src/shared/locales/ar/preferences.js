export default {
  ...
  'engine-restart-confirm': 'بعض التغييرات تتطلب إعادة تشغيل محرك التنزيل لتصبح سارية المفعول. ستتوقف التنزيلات النشطة لفترة وجيزة لكنها ستستأنف تلقائيًا بعد إعادة التشغيل.',
