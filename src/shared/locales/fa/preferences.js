export default {
  ...
  'engine-restart-confirm': 'برخی تغییرات برای اعمال شدن نیاز به راه‌اندازی مجدد موتور دانلود دارند. دانلودهای فعال به‌طور موقت متوقف می‌شوند اما پس از راه‌اندازی مجدد به‌طور خودکار از سر گرفته می‌شوند.',
  ...
  'db-reset': 'بازنشانی پایگاه داده',
  'db-reset-confirm': 'آیا مطمئنید که می‌خواهید تمام سوابق دانلود را پاک کنید؟ این عمل قابل بازگشت نیست.',
  'db-reset-success': 'پایگاه داده با موفقیت بازنشانی شد',
  ...
  'db-maintenance': 'نگهداری پایگاه داده',
  'reset': 'بازنشانی',
  'tray': 'سینی سیستم',
