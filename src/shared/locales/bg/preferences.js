export default {
  ...
  'engine-restart-confirm': 'Някои промени изискват рестартиране на двигателя за изтегляне, за да влязат в сила. Активните изтеглянията ще бъдат кратко прекъснати, но ще се възобновят автоматично след рестарт.',
  ...
  'db-reset': 'Нулиране на базата данни',
  'db-reset-confirm': 'Сигурни ли сте, че искате да изтриете всички записи за изтегляне? Това действие не може да бъде отменено.',
  'db-reset-success': 'Базата данни беше нулирана успешно',
  ...
  'db-maintenance': 'Поддръжка на базата данни',
  'reset': 'Нулиране',
