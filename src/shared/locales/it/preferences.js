export default {
  ...
  'db-reset': 'Reimposta database',
  'db-reset-confirm': 'Sei sicuro di voler cancellare tutti i record di download? Questa azione non può essere annullata.',
  'db-reset-success': 'Database reimpostato con successo',
