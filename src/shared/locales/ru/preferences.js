export default {
  ...
  'engine-restart-title': 'Перезапуск движка',
  'engine-restart-confirm': 'Изменение порта или ключа RPC требует перезапуска движка загрузки. Активные загрузки будут кратковременно прерваны, но автоматически возобновятся после перезапуска.',
  'engine-restart-now': 'Перезапустить сейчас',
  'engine-restart-later': 'Позже',
  'engine-restarting': 'Перезапуск движка...',
  'engine-restart-btn': 'Перезапустить движок',
