 ...
 *
 * Architecture:
 *   1. Detect language: URL hash (#lang=xx) > localStorage > navigator.language > en-US
...
const SUPPORTED_LOCALES = [
    'ar', 'bg', 'ca', 'de', 'el', 'en-US', 'es', 'fa', 'fr', 'hu',
    'id', 'it', 'ja', 'ko', 'nb', 'nl', 'pl', 'pt-BR', 'ro', 'ru',
    'th', 'tr', 'uk', 'vi', 'zh-CN', 'zh-TW',
];

/** Native display names for the toggle button (always in the locale's own language). */
const LOCALE_NAMES = {
    'ar': 'العربية', 'bg': 'Български', 'ca': 'Català', 'de': 'Deutsch',
    'el': 'Ελληνικά', 'en-US': 'English', 'es': 'Español', 'fa': 'فارسی',
    'fr': 'Français', 'hu': 'Magyar', 'id': 'Indonesia', 'it': 'Italiano',
    'ja': '日本語', 'ko': '한국어', 'nb': 'Norsk', 'nl': 'Nederlands',
    'pl': 'Polski', 'pt-BR': 'Português', 'ro': 'Română', 'ru': 'Русский',
...
function detectLocale() {
    ...
    const nav = resolveLocale(navigator.language);
    if (nav) return nav;
